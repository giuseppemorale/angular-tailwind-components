...
- 🎨 **Common components** — Buttons, Inputs, Modals, Tables, DatePickers, and more
...
Add the postcssrc.json in the root of the project
...
This file includes the import of tailwindcss.
If u want to override the theme tokens, you can do it in your own stylesheet:
