...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>21</td>
      <td>4</td>
      <td><strong>Current.</strong> Recommended for all new projects on Angular 21.</td>
    </tr>
    <tr>
      <td><strong>2.x</strong></td>
      <td>21</td>
      <td>4</td>
      <td><strong>Legacy.</strong> Earlier line with transitional numbering; prefer <strong>21.x</strong> for new work.</td>
    </tr>
    <tr>
